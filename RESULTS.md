...
## Round 24 — Building on Classification Breakthrough

**Цель:** Систематически оптимизировать classification подход (R23-G победитель).

**База:** R23-G — LGB-binary-23f, cutoff=0.9, dyn_threshold=0.5625, 12h rebal, 6L/3S → **Sh=2.94, Eq=$1997**

### Эксперименты

#### EXP-B: Classification + EMA / Stickiness / Conviction
**Идея:** Пост-обработка классификационных вероятностей — сглаживание, позиционная инерция, conviction weighting.

| Config | Sharpe | Equity | Worst Month | WM |
|--------|--------|--------|-------------|-----|
| cls-base | 2.94 | $1997 | -13.8% | 10/13 |
| cls-ema2 | 2.71 | $1704 | -24.4% | 10/13 |
| cls-ema3 | 2.54 | $1358 | -24.9% | 10/13 |
| cls-ema4 | 2.57 | $1422 | -28.6% | 10/13 |
| cls-stick0.02 | 2.94 | $1997 | -13.8% | 10/13 |
| cls-stick0.05 | 2.94 | $1997 | -13.8% | 10/13 |
| cls-conviction | 2.94 | $1979 | -13.8% | 10/13 |
| cls-ema3-stick | 2.54 | $1358 | -24.9% | 10/13 |
| cls-ema3-conv | 2.54 | $1343 | -24.7% | 10/13 |

**Вывод:** Stickiness и conviction не влияют (вероятности classification стабильны — ранжирование не меняется от tick к tick). EMA ухудшает.

#### EXP-E: Position Count Variations ⭐
**Идея:** Classification может работать лучше с другим числом позиций.

| Config | Sharpe | Equity | Worst Month | WM |
|--------|--------|--------|-------------|-----|
| 3L/2S | 2.49 | $1800 | -26.1% | 10/13 |
| 4L/2S | 2.52 | $1843 | -28.9% | 10/13 |
| **5L/3S** | **2.98** | **$2208** | **-16.5%** | **10/13** |
| 6L/3S (base) | 2.94 | $1997 | -13.8% | 10/13 |
| 6L/4S | 2.69 | $1110 | -17.9% | 10/13 |
| 7L/3S | 2.84 | $1702 | -15.6% | 10/13 |
| 7L/4S | 2.57 | $943 | -19.7% | 10/13 |
| 8L/4S | 2.52 | $887 | -23.0% | 10/13 |
| 8L/5S | 2.51 | $767 | -23.0% | 10/13 |
| 9L/4S | 2.42 | $795 | -23.7% | 10/13 |
| 10L/5S | 2.34 | $635 | -25.2% | 10/13 |
| 5L/5S | 2.74 | $1068 | -20.1% | 10/13 |
| 4L/4S | 2.93 | $1617 | -11.6% | 10/13 |

**Вывод:** **5L/3S → Sh=2.98, Eq=$2208** — новый лучший по Sharpe и equity! Меньше long позиций = более концентрированный портфель. 4L/4S имеет лучший worst month (-11.6%), но ниже equity.

#### EXP-G: Cutoff / Dynamic Threshold Variations
**Идея:** Перетюнить trend cutoff и dynamic threshold под classification.

| Config | Sharpe | Equity | Worst Month | WM |
|--------|--------|--------|-------------|-----|
| cut=0.85 | 2.93 | $1918 | -13.9% | 10/13 |
| cut=0.90 (base) | 2.94 | $1997 | -13.8% | 10/13 |
| cut=0.95 | 2.75 | $1655 | -21.3% | 10/13 |
| cut=1.0 | 2.75 | $1743 | -22.5% | 10/13 |
| dyn=0.4 | 2.94 | $1795 | -15.0% | 10/13 |
| dyn=0.5 | 2.95 | $1947 | -14.2% | 10/13 |
| dyn=0.5625 (base) | 2.94 | $1997 | -13.8% | 10/13 |
| dyn=0.65 | 2.91 | $2061 | -13.4% | 10/13 |
| dyn=0.75 | 2.85 | $2005 | -13.3% | 10/13 |
| cut0.95-dyn0.5 | 2.76 | $1619 | -22.0% | 10/13 |
| cut0.95-dyn0.65 | 2.73 | $1697 | -20.5% | 10/13 |
| cut1.0-dyn0.7 | 2.69 | $1726 | -22.5% | 11/13 |

**Вывод:** Baseline cutoff=0.9 оптимален. dyn=0.65 имеет максимум equity ($2061), dyn=0.75 — лучший worst month (-13.3%). Повышение cutoff (больше торговых дней) ухудшает Sharpe.

#### EXP-H: Cross-Sectional Binary Classification
**Идея:** Предсказывать "лучше рынка" (ret > cross-sectional median) вместо "рост" (ret > 0).

| Config | Sharpe | Equity | Worst Month | WM |
|--------|--------|--------|-------------|-----|
| cs-median | 1.94 | $678 | -24.6% | 9/13 |
| cs-q60 | 1.39 | $295 | -33.6% | 8/13 |
| cs-q40 | 2.20 | $1003 | -39.7% | 11/13 |

**Вывод:** Абсолютный binary target (ret > 0) значительно лучше cross-sectional. Long-short стратегии нужен абсолютный direction signal, а не relative.

#### EXP-D: LambdaRank (Learning to Rank)
**Идея:** LGB нативный lambdarank — напрямую оптимизирует NDCG ранжирования.

| Config | Sharpe | Equity | Worst Month | WM |
|--------|--------|--------|-------------|-----|
| D-lambdarank | 1.18 | $250 | -48.0% | 9/13 |

**Вывод:** Катастрофа. LambdaRank с 5 quintile labels работает ужасно для этой задачи.

#### EXP-F: Quantile Regression
**Идея:** Предсказать квантиль (0.25/0.5/0.6/0.75) вместо среднего.

| Quantile | Sharpe | Equity | Worst Month | WM |
|----------|--------|--------|-------------|-----|
| 0.25 | 1.92 | $742 | -30.2% | 9/13 |
| 0.5 (median) | 2.37 | $1296 | -27.1% | 9/13 |
| 0.6 | 1.92 | $581 | -33.9% | 10/13 |
| 0.75 | -0.40 | $47 | -32.5% | 5/13 |

**Вывод:** Median regression (Sh=2.37) приемлем, но хуже и регрессии (2.80), и классификации (2.94). Квантили ничего не дают.

#### EXP-C: Blend Regression + Classification
**Идея:** Rank-нормализованные предсказания обоих моделей смешиваются с весом alpha.

| Alpha (cls weight) | Sharpe | Equity | Worst Month | WM |
|---------------------|--------|--------|-------------|-----|
| 0.0 (pure reg) | 2.80 | $2096 | -28.5% | 10/13 |
| 0.2 | 2.58 | $1676 | -13.6% | 10/13 |
| 0.3 | 2.57 | $1636 | -26.4% | 10/13 |
| 0.4 | 2.27 | $1047 | -27.1% | 10/13 |
| 0.5 | 2.23 | $1003 | -36.0% | 9/13 |
| 0.6 | 2.49 | $1413 | -34.0% | 10/13 |
| 0.7 | 2.55 | $1529 | -33.5% | 10/13 |
| 0.8 | 2.94 | $2249 | -24.3% | 10/13 |
| 1.0 (pure cls) | 2.94 | $1997 | -13.8% | 10/13 |

**Вывод:** Blending ухудшает Sharpe в середине. Alpha=0.8 имеет максимальную equity ($2249!), но worse worst month. Чистая classification лучше по risk-adjusted.

#### EXP-A: Classification HPO (Optuna, 30 trials)
**Идея:** Оптимизация гиперпараметров LGB binary classifier.

Best trial (2 seeds): Sh=3.16, lr=0.096, leaves=111, min_child=154, l1=2.05, l2=0.56, max_depth=12.

Full eval (5 seeds): **Sh=2.95, Eq=$1737, Worst=-38.8%, WM=11/13**

**Вывод:** HPO нашёл Sh=3.16 на 2 seeds, но на 5 seeds скатился до 2.95 с worst=-38.8%. Переобучение на быстрой оценке. Default params (lr=0.03, leaves=63) стабильнее.

### R24 Финальная таблица (top-10)

| # | Experiment | Sharpe | Equity | Worst Month | Δ vs 2.94 |
|---|-----------|--------|--------|-------------|-----------|
| 1 | **E-5L-3S** | **2.98** | **$2208** | **-16.5%** | **+0.04** |
| 2 | G-dyn0.5 | 2.95 | $1947 | -14.2% | +0.01 |
| 3 | A-hpo-cls-best | 2.95 | $1737 | -38.8% | +0.01 |
| 4 | C-blend-cls0.8 | 2.94 | $2249 | -24.3% | +0.00 |
| 5 | G-dyn0.4 | 2.94 | $1795 | -15.0% | +0.00 |
| 6 | B-cls-base (=R23-G) | 2.94 | $1997 | -13.8% | +0.00 |
| 7 | E-4L-4S | 2.93 | $1617 | -11.6% | -0.01 |
| 8 | G-dyn0.65 | 2.91 | $2061 | -13.4% | -0.03 |
| 9 | G-dyn0.75 | 2.85 | $2005 | -13.3% | -0.09 |
| 10 | E-7L-3S | 2.84 | $1702 | -15.6% | -0.10 |

### R24 Ключевые выводы

1. 🏆 **НОВЫЙ РЕКОРД: E-5L-3S Sh=2.98, Eq=$2208** — 5 long, 3 short превосходит 6L/3S. Более концентрированные longs = лучшее качество сигнала.
2. **Classification + default params = оптимум.** HPO даёт переобучение (Sh=3.16 → 2.95 на full eval, с worst -38.8%).
3. **Post-processing не помогает.** EMA, stickiness, conviction, shrinkage — всё не влияет или ухудшает для classification (вероятности уже стабильны).
4. **Absolute binary target >> cross-sectional.** Предсказывать "ret>0" лучше, чем "ret>median". L/S стратегии нужен абсолютный direction.
5. **LambdaRank и quantile regression — не для этой задачи.** Sh=1.18 и Sh=1.92 соответственно.
6. **Blending reg+cls при α=0.8 даёт макс equity ($2249)** но ценой worse drawdown. Чистый cls стабильнее.
7. **Trend cutoff=0.9 оптимален.** Повышение до 0.95/1.0 ухудшает. dyn_threshold инвариантен в диапазоне 0.4-0.65.

**🏆 НОВЫЙ РЕКОРД: Sh=2.98, Eq=$2208** (LGB-binary-23f, cutoff=0.9, 12h rebal, 5L/3S)

---

## Round 25 — Ensemble & Feature Engineering for Classification

**Цель:** Построить ансамбли классификаторов, оптимизировать features и гиперпараметры.

**База:** R24-E — LGB-binary-23f, 5L/3S, cutoff=0.9, dyn=0.5625, 12h rebal → **Sh=2.98, Eq=$2208**

### Аудит утечек (pre-R25)

Полный аудит data leakage перед запуском:
- ✅ Walk-forward windows: корректные, 15-дневный purge gap
- ✅ Feature engineering: все backward-looking, cs_rank per split
- ✅ Target: forward returns правильно вычислены
- ⚠️ HPO в R22-K/R24-A: оптимизация на test Sharpe (leakage), но **НЕ влияет на рекорд** (E-5L-3S использует дефолтные параметры)
- ✅ Core strategy (classification + default params): **чистая**

### Эксперименты

#### EXP-F: 5L/3S Combined Sweep
**Идея:** Комбинировать 5L/3S с разными dyn_threshold, cutoff, rebal, и близкие позиционные варианты.

| Config | Sharpe | Equity | Worst Month | WM |
|--------|--------|--------|-------------|-----|
| 5L/3S base | 2.98 | $2208 | -16.5% | 10/13 |
| 5L/3S dyn=0.4 | 2.98 | $1969 | -17.7% | 10/13 |
| 5L/3S dyn=0.5 | 2.99 | $2148 | -16.9% | 10/13 |
| 5L/3S dyn=0.65 | 2.95 | $2283 | -16.1% | 10/13 |
| 5L/3S dyn=0.75 | 2.90 | $2229 | -16.0% | 10/13 |
| 5L/3S cut=0.85 | 2.95 | $2075 | -16.6% | 10/13 |
| 5L/3S cut=0.95 | 2.81 | $1864 | -17.6% | 10/13 |
| 5L/3S reb24h | 1.85 | $358 | -14.0% | 10/13 |
| **4L/3S** | **3.16** | **$2911** | **-6.6%** | **10/13** |
| 5L/2S | 2.37 | $1402 | -29.5% | 10/13 |
| 6L/2S | 2.32 | $1282 | -32.6% | 10/13 |

**Вывод:** **4L/3S → Sh=3.16, Eq=$2911, Worst=-6.6%!** Ещё более концентрированный long-портфель. Worst month всего 6.6% — лучший risk profile. Шорты 2 недостаточно, 3 оптимально.

#### EXP-C: Target Threshold (binary on ret > k)
**Идея:** Сдвинуть границу бинарного таргета с 0 на другое значение.

| Threshold k | Sharpe | Equity | Worst Month | WM |
|-------------|--------|--------|-------------|-----|
| -0.005 | 1.33 | $302 | -23.9% | 9/13 |
| -0.002 | 2.32 | $990 | -25.6% | 10/13 |
| 0.000 (base) | 2.98 | $2208 | -16.5% | 10/13 |
| +0.002 | 2.56 | $951 | -14.6% | 11/13 |
| +0.005 | -0.10 | $56 | -44.9% | 6/13 |
| +0.010 | -0.67 | $20 | -39.3% | 3/13 |

**Вывод:** k=0 оптимален. Любой сдвиг ухудшает. Порог +0.005 и выше катастрофичен.

#### EXP-B: Feature Selection for Classification ⭐
**Идея:** Отбор фич по importance для binary classifier (а не regression).

Feature importance ranking:

| Rank | Feature | Importance |
|------|---------|-----------|
| 1 | ls_divergence | 11770 |
| 2 | oi_zscore | 9458 |
| 3 | atr_14 | 9130 |
| 4 | taker_cvd_24h | 8707 |
| 5 | gk_vol_24h | 8406 |
| 6 | ret_48h | 8325 |
| 7 | rvol_24h | 6688 |
| 8 | mom_z_24h | 6456 |
...
| 10 | ret_24h | 6142 |
| 11 | rvol_12h | 4877 |
| 12 | pct_coins_up_12h | 4600 |
| 13 | taker_cvd_12h | 4501 |
| 14 | residual_24h | 3735 |
| 15 | oi_chg_12h | 3490 |
| 16 | iv_rv_spread | 3168 |
| 17 | residual_12h | 2422 |
| 18 | ret_12h | 2170 |
| 19 | pct_coins_up_1h | 664 |
| 20 | hour_sin | 85 |
| 21 | hour_cos | 50 |
| 22 | dow_sin | 0 |
| 23 | dow_cos | 0 |
...
| Config | Sharpe | Equity | Worst Month | WM |
|--------|--------|--------|-------------|-----|
| top-10 features | 2.06 | $678 | -32.6% | 9/13 |
| top-13 features | 2.39 | $1007 | -29.5% | 10/13 |
| **top-16 features** | **3.23** | **$2379** | **-25.7%** | **10/13** |
| top-19 features | 2.68 | $1383 | -22.5% | 10/13 |
| top-23 features (all) | 2.98 | $2208 | -16.5% | 10/13 |
| drop-3 (20f) | 3.16 | $2385 | -21.2% | 11/13 |
| drop-5 (18f) | 2.56 | $1212 | -14.6% | 9/13 |

**Вывод:** dow_sin/cos имеют нулевой importance! Удаление 3 слабых фич (dow_sin, dow_cos, hour_cos) → Sh=3.16. Top-16f → Sh=3.23 но с worse drawdown -25.7%. Паттерн: умеренный pruning помогает, агрессивный вредит.

#### EXP-E: Sample Weighting
**Идея:** Взвешивание обучающих сэмплов (по |return|, по свежести).

| Config | Sharpe | Equity | Worst Month | WM |
|--------|--------|--------|-------------|-----|
| weight by |ret| | 0.74 | $140 | -41.9% | 9/13 |
| weight by √|ret| | 1.43 | $311 | -18.3% | 7/13 |
| recency 365d half-life | 2.05 | $786 | -28.9% | 10/13 |
| recency 180d half-life | 0.81 | $149 | -36.7% | 8/13 |

**Вывод:** Все виды weighting ухудшают. Classification уже хорошо справляется с шумными сэмплами.

#### EXP-G: Tree Depth + Regularization ⭐⭐
**Идея:** Варьировать структуру деревьев и регуляризацию.

| Config | Sharpe | Equity | Worst Month | WM |
|--------|--------|--------|-------------|-----|
| leaves=31 | 2.57 | $1436 | -24.9% | 9/13 |
| leaves=63 (base) | 2.98 | $2208 | -16.5% | 10/13 |
| leaves=127 | 2.22 | $812 | -27.2% | 10/13 |
| leaves=255 | 2.70 | $1302 | -13.3% | 11/13 |
| **min_child=50** | **3.40** | **$3554** | **-22.8%** | **11/13** |
| min_child=200 | 2.82 | $1736 | -11.0% | 10/13 |
| l2=0.1 | 2.89 | $2098 | -30.2% | 11/13 |
| l2=5.0 | 2.67 | $1475 | -29.3% | 10/13 |
| l2=10.0 | 2.55 | $1340 | -24.8% | 10/13 |
| lr=0.01 | 2.35 | $955 | -24.4% | 10/13 |
| lr=0.05 | 2.63 | $1447 | -30.3% | 10/13 |
| **lr=0.1** | **3.37** | **$2828** | **-14.4%** | **10/13** |
| subsample=0.6 | 2.98 | $2208 | -16.5% | 10/13 |
| colsample=0.6 | 2.36 | $1094 | -25.7% | 10/13 |
| deep (leaves=127, minch=50, depth=8) | 2.59 | $1236 | -15.2% | 8/13 |
| shallow (leaves=31, minch=200, l2=5) | 2.37 | $1103 | -30.1% | 9/13 |

**Вывод:** Два прорыва!
- **min_child_samples=50 → Sh=3.40, Eq=$3554** — меньше min_child = деревья подстраиваются точнее. Но worst -22.8%.
- **lr=0.1 → Sh=3.37, Eq=$2828** — быстрое обучение с ранним early stopping работает лучше. Worst -14.4%. Более стабильный.

#### EXP-D: Multi-Horizon Classification
**Идея:** Классификаторы на 12h/24h/48h, блендинг сигналов.

| Config | Sharpe | Equity | Worst Month | WM |
|--------|--------|--------|-------------|-----|
| cls-12h (base) | 2.98 | $2208 | -16.5% | 10/13 |
| cls-24h | 1.22 | $250 | -19.1% | 9/13 |
| cls-48h | 0.54 | $113 | -33.5% | 6/13 |
| multi-eq (equal blend) | 1.72 | $426 | -25.9% | 8/13 |
| multi-12h-heavy (0.6/0.2/0.2) | 1.74 | $489 | -25.1% | 10/13 |
| multi-12h+24h (50/50) | 2.23 | $963 | -19.5% | 10/13 |

**Вывод:** 12h horizon оптимален. 24h и 48h значительно хуже. Блендинг горизонтов не помогает.

#### EXP-A: Classifier Ensemble (LGB + XGB + CatBoost) ⭐⭐
**Идея:** Три GBDT классификатора, блендинг вероятностей.

| Config | Sharpe | Equity | Worst Month | WM |
|--------|--------|--------|-------------|-----|
| LGB-cls (base) | 2.98 | $2208 | -16.5% | 10/13 |
| **XGB-cls** | **3.14** | **$2960** | **-10.6%** | **10/13** |
| CB-cls | 2.53 | $1391 | -8.6% | 10/13 |
| ensemble-eq-3 | 2.55 | $1488 | -22.4% | 10/13 |
| ensemble-lgb-heavy | 2.72 | $1746 | -15.4% | 11/13 |
| **ensemble-lgb+xgb** | **3.36** | **$3371** | **-5.7%** | **10/13** |
| ensemble-lgb+cb | 2.72 | $1930 | -22.3% | 11/13 |

**Вывод:** 
- **XGB-cls самостоятельно → Sh=3.14, Eq=$2960, Worst=-10.6%!** XGBoost classifier лучше LGB для этой задачи!
- **LGB+XGB ensemble → Sh=3.36, Eq=$3371, Worst=-5.7%** — лучший risk-adjusted результат. Минимальный worst month при высоком Sharpe и equity.
- CatBoost-cls слабее, тройной ансамбль хуже парного (CatBoost размывает сигнал).

#### EXP-H: Proper Val-Based HPO (без утечки на test)
**Идея:** HPO оптимизирует val-AUC (а не test Sharpe) → без data leakage.

Best trial: AUC=0.5194, lr=0.035, leaves=42, min_child=168, max_depth=2

| Config | Sharpe | Equity | Worst Month | WM |
|--------|--------|--------|-------------|-----|
| H-val-hpo-best | 2.37 | $1349 | -36.3% | 11/13 |
| H-default-5L3S | 2.98 | $2208 | -16.5% | 10/13 |

**Вывод:** HPO без утечки даёт Sh=2.37 (хуже defaults). Val-AUC=0.5194 — модель едва лучше монетки на val. Default params лучше любого HPO.

### R25 Финальная таблица (top-10)

| # | Experiment | Sharpe | Equity | Worst Month | Δ vs 2.98 |
|---|-----------|--------|--------|-------------|-----------|
| 1 | **G-minchild50** | **3.40** | **$3554** | **-22.8%** | **+0.42** |
| 2 | **G-lr0.1** | **3.37** | **$2828** | **-14.4%** | **+0.39** |
| 3 | **A-ens-lgb+xgb** | **3.36** | **$3371** | **-5.7%** | **+0.38** |
| 4 | B-top16f | 3.23 | $2379 | -25.7% | +0.25 |
| 5 | F-4L-3S | 3.16 | $2911 | -6.6% | +0.18 |
| 6 | B-drop3 | 3.16 | $2385 | -21.2% | +0.18 |
| 7 | A-xgb-cls | 3.14 | $2960 | -10.6% | +0.16 |
| 8 | F-5L3S-dyn0.5 | 2.99 | $2148 | -16.9% | +0.01 |
| 9 | F-5L3S-base (=R24) | 2.98 | $2208 | -16.5% | 0.00 |
| 10 | F-5L3S-cut0.85 | 2.95 | $2075 | -16.6% | -0.03 |

### R25 Ключевые выводы

1. 🏆 **3 новых рекорда выше Sh=3.3!** G-minchild50 (3.40), G-lr0.1 (3.37), A-ens-lgb+xgb (3.36).
2. **Лучший risk-adjusted: A-ens-lgb+xgb** — Sh=3.36, Eq=$3371, Worst=-5.7%. Ансамбль LGB+XGB классификаторов даёт диверсификацию при минимальном drawdown.
3. **4L/3S → Sh=3.16, Worst=-6.6%** — ещё более концентрированные longs работают лучше.
4. **min_child_samples=50** — самый высокий Sharpe (3.40) но worst month -22.8%.
5. **lr=0.1 (с early stopping)** — быстрое обучение даёт Sh=3.37 с умеренным drawdown -14.4%.
6. **XGBoost classifier > LGB classifier** в standalone (Sh=3.14 vs 2.98).
7. **Sample weighting, multi-horizon, target threshold, val-HPO** — всё ухудшает.
8. **Feature pruning помогает:** удаление dow_sin/cos/hour_cos (importance=0) → Sh=3.16.
